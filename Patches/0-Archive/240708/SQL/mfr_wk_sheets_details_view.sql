...
begin
    ...
    -- prepare sql
        ...
        declare @where nvarchar(max) = concat(
            ' where (1=1)'
            , case 
                when @completed = 1 then ' and (x.wk_completion = 1)' 
                when @completed = 0 then ' and (x.wk_completion < 1)' 
                when @search is null 
...
-- <D_FROM>2024-07-10</D_FROM>
-- <D_TO>2024-07-10</D_TO>
-- </f>', @trace = 1
