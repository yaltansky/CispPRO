		...
		begin
			...
			-- @sql
                ...
                SELECT 
                    ...
                    DURATION_NAME = CONCAT(CAST(X.DURATION AS DECIMAL(18,2)), DUR.NAME),
                    DURATION_WK_NAME = CONCAT(CAST(X.DURATION_WK AS DECIMAL(18,2)), DUR2.NAME),
                    PLAN_HOURS = X.DURATION_WK * DUR2.FACTOR / DUR_H.FACTOR,
                    C.UNIT_NAME
                FROM ' + @subquery + '
                    ...
                    join projects_durations dur on dur.duration_id = x.duration_id
                    join projects_durations dur2 on dur2.duration_id = x.duration_wk_id				
